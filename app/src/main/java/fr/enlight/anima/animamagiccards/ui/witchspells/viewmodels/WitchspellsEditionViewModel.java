...
import fr.enlight.anima.animamagiccards.ui.witchspells.viewmodels.secondary.WitchspellsSecondarySpellbookViewModel;
...
public class WitchspellsEditionViewModel extends BaseObservable implements BindableViewModel,
    ...
    public WitchspellsEditionViewModel(@NonNull Spellbook spellbook, @Nullable WitchspellsPath witchspellsPath, @NonNull Listener listener) {
