...
class SpellFileParserTest {
    ...
    fun should_have_14_secondary_spellbooks_when_ask_parse_spanish() {
        ...
        // When
        val spellFileParser = SpellFileParser(descriptor)
    ...
    @Test
    fun should_map_spells_line_when_ask_mapping_of_spells_in_spanish() {
        // Given
        ...
        assertThat(spellMap[descriptor.typeMarker], equalTo("Tipo de Conjuro: Efecto, Detección;;;;;"))
    }

    @Test
    fun should_create_spell_when_ask_spell_creation_with_spell_map_in_spanish() {
        // Given
        val spellFirstLines = listOf(
                "Sentir el Caos;;;;;\n",
                "Nivel: 4 /Acción: Activa;;;;;\n",
